"""Local Live API demo. Run: python -m uvicorn app:app --host 127.0.0.1 --port 8003."""
...
if __name__ == '__main__':
    import uvicorn
    uvicorn.run('app:app', host='127.0.0.1', port=int(os.getenv('DEMO_PORT', '8003')), reload=False)
